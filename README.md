...
## Feb 28
The flags chapter was completely useless. It doesn't list any compiler flags (it only lists "future flags", which I currently don't care about), much less what any of them do. The chapter also doesn't say how flags are represented internally nor give any functions or files related to compiler flags. So it's once again time to sift through the code looking for answers.
